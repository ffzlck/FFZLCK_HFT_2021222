...
namespace FFZLCK_HFT_2021222.Endpoint
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRepository<Clip>, ClipRepository>();
            services.AddTransient<IRepository<Performer>, PerformerRepository>();

            services.AddTransient<IAlbumLogic, AlbumLogic>();
            services.AddTransient<IMusicLogic, MusicLogic>();
            services.AddTransient<IClipLogic, ClipLogic>();
            services.AddTransient<IPerformerLogic, PerformerLogic>();

            services.AddControllers();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "FFZLCK_HFT_2021222.Endpoint", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "FFZLCK_HFT_2021222.Endpoint v1"));
            }
